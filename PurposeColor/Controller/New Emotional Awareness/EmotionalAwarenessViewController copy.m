...
-(void)setUp{
    ...
    menuCount = 0;
    imgFeel.image = [UIImage imageNamed:@"Rate_Feel"];
    imgEmotion.image = [UIImage imageNamed:@"Select_Emotion"];
    imgRate.image = [UIImage imageNamed:@"Rate_Reaction"];
    imgGoalsAndDreams.image = [UIImage imageNamed:@"Select_Goal"];
    imgAction.image = [UIImage imageNamed:@"Select_Action"];
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if (section == 1) {
        return menuCount;
    }else return arrDataSource.count;
    return 1;
}
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        if (isJournalSet) {
            ...
            float heightforView = self.view.frame.size.height - 65 - 70;
...
-(IBAction)showFeelList:(id)sender{
    
    [btnFeel setBackgroundColor:[UIColor colorWithRed:215.f/255.f green:215.f/255.f blue:215.f/255.f alpha:0.5]];
    [btnEmotion setBackgroundColor:[UIColor whiteColor]];
    [btnRate setBackgroundColor:[UIColor whiteColor]];
    [btnGoalsAndDreams setBackgroundColor:[UIColor whiteColor]];
    [btnAction setBackgroundColor:[UIColor whiteColor]];
    lblMenuName.text = @"Rate how you feel";
    [self removeAllViews];
    [self showRateSelection];
}
-(IBAction)showEmotionList:(id)sender{
    
    if (![dictSelectedSteps objectForKey:[NSNumber numberWithInteger:eTypeFeel]]) return;
    [btnFeel setBackgroundColor:[UIColor whiteColor]];
    [btnEmotion setBackgroundColor:[UIColor colorWithRed:215.f/255.f green:215.f/255.f blue:215.f/255.f alpha:0.5]];
    [btnRate setBackgroundColor:[UIColor whiteColor]];
    [btnGoalsAndDreams setBackgroundColor:[UIColor whiteColor]];
    [btnAction setBackgroundColor:[UIColor whiteColor]];
    lblMenuName.text = @"Select your emotion";
    [self removeAllViews];
    [self showEmotionSelection];
}
-(IBAction)showDriveList:(id)sender{
    
     if (![dictSelectedSteps objectForKey:[NSNumber numberWithInteger:eTypeEmotion]]) return;
    [btnFeel setBackgroundColor:[UIColor whiteColor]];
    [btnEmotion setBackgroundColor:[UIColor whiteColor]];
    [btnRate setBackgroundColor:[UIColor colorWithRed:215.f/255.f green:215.f/255.f blue:215.f/255.f alpha:0.5]];
    [btnGoalsAndDreams setBackgroundColor:[UIColor whiteColor]];
    [btnAction setBackgroundColor:[UIColor whiteColor]];
    lblMenuName.text = @"Rate reaction";
    [self removeAllViews];
...
-(IBAction)showGoalsList:(id)sender{
    ...
    [btnEmotion setBackgroundColor:[UIColor whiteColor]];
    [btnRate setBackgroundColor:[UIColor whiteColor]];
    [btnGoalsAndDreams setBackgroundColor:[UIColor colorWithRed:215.f/255.f green:215.f/255.f blue:215.f/255.f alpha:0.5]];
    [btnAction setBackgroundColor:[UIColor whiteColor]];
    lblMenuName.text = @"Select goal";
    [self removeAllViews];
    [self showGoalsAndDreamsSelection];
}
-(IBAction)showActionList:(id)sender{
    
     if (![dictSelectedSteps objectForKey:[NSNumber numberWithInteger:eTypeGoalsAndDreams]]) return;
    [btnFeel setBackgroundColor:[UIColor whiteColor]];
    [btnEmotion setBackgroundColor:[UIColor whiteColor]];
    [btnRate setBackgroundColor:[UIColor whiteColor]];
    [btnGoalsAndDreams setBackgroundColor:[UIColor whiteColor]];
    [btnAction setBackgroundColor:[UIColor colorWithRed:215.f/255.f green:215.f/255.f blue:215.f/255.f alpha:0.5]];
    lblMenuName.text = @"Select action";
    [self removeAllViews];
...
-(void)showEventSelectionView{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwEventSelection]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwEventSelection)]];
...
-(void)showRateSelection{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwFeelSelection]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwFeelSelection)]];
...
-(void)showEmotionSelection{
   ...
   // vwEmotionSelection.emotionaValue = selectedFeelValue;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwEmotionSelection]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwEmotionSelection)]];
...
-(void)showDriveSelection{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwDriveSelection]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwDriveSelection)]];
...
-(void)showGoalsAndDreamsSelection{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwGoalsSelection]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwGoalsSelection)]];
...
-(void)showActionSelection{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[vwActions]-70-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(vwActions)]];
