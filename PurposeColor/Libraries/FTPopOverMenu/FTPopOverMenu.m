...
#define FTDefaultMenuFont           [UIFont fontWithName:CommonFont size:14]
#define FTDefaultMenuWidth          110.0
               ...
               iconImageName:(NSString *)iconImageName
{
    ...
    if (self) {
        ...
        _menuNameLabel.textAlignment = NSTextAlignmentCenter;// [FTPopOverMenuConfiguration defaultConfiguration].textAlignment;
