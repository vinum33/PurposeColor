...
const CGFloat kJCNotificationBannerViewMarginX = 30.0;
...
- (id) initWithNotification:(JCNotificationBanner*)notification {
  ...
  if (self) {
    ...
    self.messageLabel.font = [UIFont fontWithName:CommonFont size:14];
...
- (void) layoutSubviews {
  ...
  if (spillY > 0.0) {
    ...
    self.iconImageView.frame = CGRectMake(5, 15, 20, 20);
}
